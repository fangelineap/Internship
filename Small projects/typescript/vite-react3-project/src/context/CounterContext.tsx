import { ChangeEvent, createContext, useReducer, ReactElement, useCallback, useContext } from "react";
...
const reducer = (state: StateType, action: ReducerAction): StateType => {
    switch(action.type) {
        ...
        case REDUCER_ACTION_TYPE.NEW_INPUT:
            // if action.payload === null, isi dgn empty string
...
export const useCounterText = (): UseCounterTextHookType => {
    const { state: {text}, handleTextInput } = 
    useContext(CounterContext)
